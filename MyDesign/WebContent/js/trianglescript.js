...
letzChaat.controller('loginController',['$scope','$http','$location','$rootScope',function($scope,$http,$location,$rootScope)		
 ...
 $http.post('http://localhost:8080/Collaboration/authenticate',loginData).then(function (response) {
...
letzChaat.controller('registerController',function($scope,$http)		
		{
			$scope.register=function()
			{
				...
				var userData={
				 ...
				 var res = $http.post('http://localhost:8080/Collaboration/addUser',userData);
...
letzChaat.controller("adminBlogController",function($scope,$http,$rootScope)	
	...
	console.log("after this");
			 $http.get("http://localhost:8080/Collaboration/viewBlogs")
			...
			$scope.addBlog=function(newBlog)
			{
				...
				console.log("title:"+dataObj);
				 var res = $http.post('http://localhost:8080/Collaboration/addBlog',dataObj);
				 $http.get("http://localhost:8080/Collaboration/viewBlogs")
			...
			$scope.saveEdit=function()
			{
				...
				$http.put('http://localhost:8080/Collaboration/updateBlog', dataObj);
				$http.get("http://localhost:8080/Collaboration/viewBlogs")
		 	    .then(function (response) {$scope.blogs = response.data;});
			}
			$scope.deleteBlog=function(blogDataToEdit)
			{
				...
				$http['delete']('http://localhost:8080/Collaboration/deleteBlog/'+blogDataToEdit.blogId);
				 $http.get("http://localhost:8080/Collaboration/viewBlogs")
			 	    .then(function (response) {$scope.blogs = response.data;});
			}
			...
			$scope.approveBlog=function(i)
			{
				...
				$http.put('http://localhost:8080/Collaboration/approveBlog/'+i, dataObj);
				$http.get("http://localhost:8080/Collaboration/viewBlogs")
		 	    .then(function (response) {$scope.blogs = response.data;});
			}
...
letzChaat.controller("blogController",function($scope,$http,$rootScope)	
	...
	console.log("after this");
			...
			$scope.addBlogComment = function(newBlogComment)
			{
				...
				var res = $http.post('http://localhost:8080/Collaboration/addBlogComment',dataObj);
				$scope.newBlogComment.blogID="";
				$scope.newBlogComment.blogComment="";
					
				 /*$http.get("http://localhost:8080/Collaboration/viewBlogComments")
...
letzChaat.controller("adminEventController",function($scope,$http,$rootScope,$filter)	
	...
	console.log("after this");
			...
			$scope.addEvent=function(newEvent)
			{
				...
				console.log("title:"+dataObj);
				 var res = $http.post('http://localhost:8080/Collaboration/addEvent',dataObj);
				 $http.get("http://localhost:8080/Collaboration/viewEvents")
			...
			$scope.saveEdit=function()
			{
				...
				$http.put('http://localhost:8080/Collaboration/updateEvent', dataObj);
				$http.get("http://localhost:8080/Collaboration/viewEvents")
		 	    .then(function (response) {$scope.events = response.data;});
			}
			$scope.deleteEvent=function(eventDataToEdit)
			{
				...
				$http['delete']('http://localhost:8080/Collaboration/deleteEvent/'+eventDataToEdit.eventId);
				 $http.get("http://localhost:8080/Collaboration/viewEvents")
			 	    .then(function (response) {$scope.events = response.data;});
			}
...
letzChaat.controller('jobsController',function($scope,$http,$rootScope)		
    ...
    $http.get("http://localhost:8080/Collaboration/viewAllJobs")
    .then(function (response) {$scope.jobs = response.data;});
    $http.get("http://localhost:8080/Collaboration/jobsApplied")
	...
	{	console.log("In jobController............");
		...
		console.log("title:"+dataObj);
		 var res = $http.post('http://localhost:8080/Collaboration/addJob',dataObj);
		 $http.get("http://localhost:8080/Collaboration/viewAllJobs")
	 	    .then(function (response) {$scope.jobs = response.data;});
	 		res.success(function(data, status, headers, config) {
	 			$scope.message = data;
	...
	$scope.saveEdit=function()
	{
		...
		$http.put('http://localhost:8080/Collaboration/updateJob', dataObj);
		$http.get("http://localhost:8080/Collaboration/viewAllJobs")
 	    .then(function (response) {$scope.jobs = response.data;});
	}
	$scope.deleteJob=function(jobDataToEdit)
	{
		...
		$http['delete']('http://localhost:8080/Collaboration/deleteJob/'+jobDataToEdit.jobId);
		 $http.get("http://localhost:8080/Collaboration/viewAllJobs")
	 	    .then(function (response) {$scope.jobs = response.data;});
	}
    ...
    $scope.applyJob=function()
    {
    	...
    	/* studentId:$scope.studentId,*/
    	 certificateNumber:$scope.certificateNumber	
    	 	...
    	 	$http.post('http://localhost:8080/Collaboration/registerJob',jobData).then(function (response) {
		 console.log("result   data:"+response.data);
		 var r=response.data.toString();
		 console.log("response:"+r);
...
letzChaat.controller("forumController",function($scope,$http,$rootScope)	
	...
	console.log("after this");
			 $http.get("http://localhost:8080/Collaboration/viewForums")
			    .then(function (response) {
			...
			$scope.addForum=function(newForum)
			{
				...
				var res = $http.post('http://localhost:8080/Collaboration/addForum',dataObj);
				 $http.get("http://localhost:8080/Collaboration/viewForums")
			...
			$scope.saveEdit=function()
			{
				...
				$http.put('http://localhost:8080/Collaboration/updateForum', dataObj);
				$http.get("http://localhost:8080/Collaboration/viewForums")
		 	    .then(function (response) {$scope.forums = response.data;});
			}
			$scope.deleteForum=function(forumDataToEdit)
			{
				...
				$http['delete']('http://localhost:8080/Collaboration/deleteForum/'+forumDataToEdit.forumId);
				 $http.get("http://localhost:8080/Collaboration/viewForums")
			 	    .then(function (response) {$scope.forums = response.data;});
			}
...
letzChaat.controller("friendController",function($scope,$http,$rootScope)
	...
	$rootScope.friends=true;
		...
		$http.get("http://localhost:8080/Collaboration/currentUser")
	    .then(function (response) {$scope.currentUser = response.data;});
		
		
		
		$http.get("http://localhost:8080/Collaboration/newFriends")
		...
		$scope.sendFriendRequest=function(user)
		{
			...
			$http.post('http://localhost:8080/Collaboration/addFriend/'+user.username);
...
letzChaat.controller("friendRequestController",function($scope,$http,$rootScope)
	...
	$rootScope.friends=true;
		...
		$http.get("http://localhost:8080/Collaboration/getMyFriendRequests")
	    .then(function (response) {$scope.users = response.data;});
		...
		$scope.acceptRequest=function(user)
		{
			...
			$http.put('http://localhost:8080/Collaboration/acceptFriend/'+user.userID);
		...
		$scope.rejectRequest=function(user)
		{
			...
			$http.put('http://localhost:8080/Collaboration/rejectFriend/'+user.userID);
...
letzChaat.controller("MyFriendsController",function($scope,$http,$rootScope)
	...
	$rootScope.friends=true;
		...
		$http.get("http://localhost:8080/Collaboration/myFriends")
	    .then(function (response) {$scope.users = response.data;});
		...
		$scope.unfriend=function(user)
		{
			...
			$http.put('http://localhost:8080/Collaboration/unFriend/'+user.friendID);
